...
$(document).on('click', '#btnAdd-1', function () {
    method_1 = 'tambah';
    judulModal_1.html("Tambah Data Penelitian Ristekdikti");
...
$(document).on('click', '.btnEdit-1', function () {
    method_1 = 'edit';
    judulModal_1.html("Edit Penelitian Ristekdikti");
