...
function draw_data_2(result) {
    ...
    for (index in result) {
        ...
        output += '<td>' + Urut + '</td>';
        output += '<td>';
        output += '<div class="row"><div class="col-sm-12"><button dataID="' + Id + '" dataKode="' + Id_Hki + '"  class="btn btn-danger btn-sm mb-1 btnHapus-2"> <i class="fa fa-trash"></i></button></div></div>';
        output += '</td>'
        output += '</tr>'
...
clickSave_1.addEventListener('click', function (event) {
    ...
    if (method_1 == 'tambah') {
        url = base_url + 'Hki/save';
    } else {
        url = base_url + 'Hki/saveEdit';
    }
...
clickSave_2.addEventListener('click', function () {
    ...
    if (method_2 == 'tambah') {
        url = base_url + 'Hki/save2';
    } else {
        url = base_url + 'Hki/saveEdit2';
    }
