                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="User" href="<?= base_url('Dashboard/user') ?>"><span class="mini-sub-pro">Data User</span></a></li>
                                <li><a title="" href="#"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="" href="#"><span class="mini-sub-pro">Dashboard v.3</span></a></li>
                            </ul>
                        </li>
                        <li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="<?= base_url('home/logout') ?>"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
