<div class="container back-ground">
    ...
    <div class="m-3">
        ...
        <ul class="nav nav-tabs pl-2 pr-2" id="tab-1" role="tablist">
            <li class="nav-item">
                <a href="#data-1" class="nav-link active" id="nav-1" data-toggle="tab" role="tab">Karya Ilmiah</a>
            </li>
            <li class="nav-item">
                <a href="#data-2" class="nav-link" id="nav-2" data-toggle="tab" role="tab">Penulis Karya Ilmiah</a>
            </li>
        </ul>
        <!--  -->
                    ...
                    <table class="table table-hover tabel-1">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 15%;">NIDN</th>
                                <th class="text-center" style="max-width: 150px;">Nama Pemakalah</th>
                                <th class="text-center" style="width: 10%;">Status Pemakalah</th>
                                <th class="text-center" style="max-width: 200px;">Judul Makalah</th>
                                <th class="text-center" style="width: 15%;">Nama Forum</th>
                                <th class="text-center" style="width: 15%;">Institusi Penyelenggara</th>
                                <th class="text-center" style="width: 15%;">Halaman</th>
                                <th class="text-center" style="width: 15%;">Tempat Pelaksana</th>
                                <th class="text-center" style="width: 15%;">Dokumen</th>
                                <th class="text-center" style="max-width: 90px;">Aksi</th>
                            </tr>
                        </thead>
                    ...
                    <table class="table table-hover tabel-2">
                        <thead>
                            <tr>
                                ...
                                <th class="col text-center" style="width: 15%;">Id Karya</th>
                                <th class="col text-center" style="width: 20%;">Nama Penulis</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" id="form-1" link="<?= base_url(); ?>" enctype="multipart/form-data">
                    ...
                    <div class=" form-group row">
                        <label class="col-sm-2 col-form-label" for="Nama">Nama Pemakalah</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-9">
                    ...
                    <div class=" form-group row">
                        <label class="col-sm-2 col-form-label" for="Status">Status Pemakalah</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-9">
                    ...
                    <div class=" form-group row">
                        <label class="col-sm-2 col-form-label" for="Judul">Judul Makalah</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-9">
                    ...
                    <div class=" form-group row">
                        <label class="col-sm-2 col-form-label" for="Forum">Nama Forum</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="Institusi">Institusi Penyelenggara</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-2" link="<?= base_url(); ?>">
                    ...
                    <input type="hidden" id="Id_Karya" name="Id_Karya">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="Nama_Penulis">Nama Penulis</label>
                        <label for="" class="col-sm-1 col-form-label text-center">:</label>
                        <div class="col-sm-8">
