                    ...
                    <table class="table table-hover tabel-1 table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="max-width: 30%; min-width: 150px;">Judul Pengabdian</th>
                                <th class="text-center" style="max-width: 30%; min-width: 130px;">Program Studi</th>
                                <th class="text-center" style="min-width: 140px;">Dana</th>
                    ...
                    <table class="table table-hover tabel-2 table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="max-width: 30%; min-width: 150px;">NIDN</th>
                                <th class="text-center" style="max-width: 30%; min-width: 150px;">Nama Anggota</th>
                                <th class="text-center" style="max-width: 30%; min-width: 130px;">Jabatan</th>
                                <th class="text-center" style="max-width: 10%; min-width: 80px;">Aksi</th>
                            </tr>
                        </thead>
                ...
                <div class="tabel pt-2">
                    <table class="table table-hover tabel-3 table-responsive">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 10%;">No</th>
                                <th class="text-center" style="max-width: 40%; min-width: 150px;">Nama TIM Pendukung</th>
                                <th class="text-center" style="max-width: 40%; min-width: 130px;">Jabatan</th>
                                <th class="text-center" style="max-width: 10%; min-width: 80px;">Aksi</th>
                            </tr>
                        </thead>
