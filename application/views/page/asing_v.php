    ...
    <div class="field">
        ...
        <div class="tab-content" id="content-tabs">
                    ...
                    <table class="table table-hover tabel-2 table-responsive-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="min-width: 150px;">Nama Anggota</th>
                                <th class="text-center" style="min-width: 120px;">Jabatan</th>
            ...
            <div class="tab-pane fade" id="data-3">
                ...
                <!--  -->
                <div class="tabel pt-2">
                    <table class="table table-hover tabel-3 table-responsive-sm">
                        <thead>
                            <tr>
                                <th class="col text-center" style="min-width: 50px;">No</th>
                                <th class="col text-center" style="min-width: 150px;">Nama TIM Pendukung</th>
                                <th class="col text-center" style="min-width: 130px;">Jabatan</th>
                                <th class="col text-center" style="min-width: 80px;">Aksi</th>
                            </tr>
                        </thead>
